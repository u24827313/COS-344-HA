...
void main() {
    ...
    luminance = pow(luminance, 0.85);  // softer contrast curve (was 0.7)
    FragColour = vec4(luminance * 0.3, luminance * 1.0, luminance * 0.3, 0.5);  // less saturated green, slight transparency
}